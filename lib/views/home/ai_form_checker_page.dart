...
class _AiFormCheckerPageState extends State<AiFormCheckerPage> {
  ...
  void _analyze() {
    ...
    if (exerciseName.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Nama latihan tidak boleh kosong!')),
      );
      return;
    }

    Provider.of<AiFormCheckerController>(
      context,
      listen: false,
  ...
  Widget _buildResultCard(FormCheckResult result) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Hasil Analisis (Skor: ${result.score}/100)',
                    ...
                    children: [
                      Icon(
                        point.type == 'good'
                            ...
                            : Icons.error_outline,
                        color:
                            point.type == 'good' ? Colors.green : Colors.orange,
                        size: 20,
                      ),
